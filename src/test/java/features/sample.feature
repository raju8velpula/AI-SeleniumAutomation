Feature: CCM Client portal access and navigation
  ...
  @practice
  Scenario: Verify alert popup on Practice Automation Popups page
    Given the Practice Automation site URL "https://practice-automation.com/"
    When I open the Practice Automation site
    And I navigate to the "Popups" page
    Then I should be on the Popups page "https://practice-automation.com/popups/"
    When I click the popup button labeled "Show Alert"
    Then an alert popup should be displayed with text
    And I close the alert popup
